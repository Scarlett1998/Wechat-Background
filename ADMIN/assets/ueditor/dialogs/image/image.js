...
(function () {
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            $.get("https://www.iw3c.top/wechat/admin/index.php?mode=oss&action=auth", {}, function (sign) {OssSign = JSON.parse(sign);});
           ...
           /* $upload.on('click', function () {
            ...
            $upload.on('click', function() {
            	...
            	if(!OssSign) {
            		$.get("https://www.iw3c.top/wechat/admin/index.php?mode=oss&action=auth", {}, function(sign) {
