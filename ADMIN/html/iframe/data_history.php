          ...
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
             ...
             <?php 
             	...
             	{ include "function/history_alone.php";  $Id++;}
            ...
            if($page!=1)echo "<li ><a href=\"index.php?mode=data&action=history&page={$page_l}&total={$total}\">«</a></li>";
            if($pageall<=6)
            {
            	 for($i=1;$i<=$pageall;$i++)
               {
            	...
            	echo "<li {$class}><a href=\"index.php?mode=data&action=history&page={$i}&total={$total}\">$i</a></li>";
               }
            }
            else
            {
            ...
            if($page!=$pageall)echo "<li ><a href=\"index.php?mode=data&action=history&page={$page_r}&total={$total}\">«</a></li>";
                  ?>
